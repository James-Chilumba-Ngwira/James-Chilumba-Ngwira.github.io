                    ...
                    <Grid container spacing={3}>
                                        ...
                                        <Box key={item.name}>
                                            ...
                                            <LinearProgress
                                                ...
                                                sx={{
                                                    ...
                                                    borderRadius: 5,
                                                    bgcolor: '#F1F5F9',
                                                    '& .MuiLinearProgress-bar': { bgcolor: '#3E9773' }
                                                }}
                                            />
                                        </Box>
                                    ))}
                                ...
                                <Box sx={{ flexGrow: 1, display: 'grid', placeItems: 'center', position: 'relative' }}>
                                    {programLoading ? <CircularProgress /> : (
                                        <Box sx={{
                                            ...
                                            borderTopColor: '#0B6E4F',
                                            borderRightColor: '#3E9773',
                                            display: 'grid',
                                            placeItems: 'center'
                                        }}>
                        ...
                        <Grid size={{ xs: 12 }}>
                            <Paper elevation={0} sx={{ p: 3, borderRadius: 3, border: '1px solid #E2E8F0' }}>
                                ...
                                <Box sx={{ height: 200, bgcolor: alpha('#0B6E4F', 0.05), borderRadius: 2, display: 'grid', placeItems: 'center' }}>
