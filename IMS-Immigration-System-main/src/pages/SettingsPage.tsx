            ...
            <Grid container spacing={4}>
                ...
                <Grid size={{ xs: 12, md: 4 }}>
                    <Paper elevation={0} sx={{
                        ...
                        <Avatar
                            sx={{
                                width: 100, height: 100, mx: 'auto', mb: 3, border: '6px solid #F8FAFC',
                                bgcolor: 'primary.main', color: '#fff', fontWeight: 800, fontSize: 32,
                            }}
                        >
                            {(formData.fullName || "Admin").split(' ').map((n) => n[0]).join('').toUpperCase().slice(0, 2)}
                        </Avatar>
